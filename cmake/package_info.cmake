...
function(callback_start)
	if(NOT CMAKE_SYSTEM_NAME STREQUAL "Android")
		...
		if(IS_DIRECTORY ${JUGIMAP_FRAMEWORK_SOURCE_DIR})
			...
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/FrameworkDemo/jugiApp DESTINATION ${CMAKE_SOURCE_DIR}/src)
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/FrameworkDemo/FrameworkDemo_nCine/ DESTINATION ${CMAKE_SOURCE_DIR}/src)
		endif()
	endif()
endfunction()
...
function(callback_before_target)
	if(NOT CMAKE_SYSTEM_NAME STREQUAL "Android" AND IS_DIRECTORY ${PACKAGE_DATA_DIR})
		if(IS_DIRECTORY ${JUGIMAP_FRAMEWORK_SOURCE_DIR})
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/FrameworkDemo/media/fonts DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/FrameworkDemo/media/graphics DESTINATION ${PACKAGE_DATA_DIR}/data/media)
			file(COPY ${JUGIMAP_FRAMEWORK_SOURCE_DIR}/examples_c++/FrameworkDemo/media/maps DESTINATION ${PACKAGE_DATA_DIR}/data/media)
		endif()
